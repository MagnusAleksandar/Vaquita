...
import com.componentes.vaquita.presentacion.ui.viewmodel.*
...
fun AppRoutes() {
    ...
    val imageApi = RetrofitClient.create(ImageApi::class.java)

    // Repositories
    val goalRepository = GoalRepository(goalApi, contributionApi, imageApi)
